...
test("verify script reports the current local F0-F5/B1/B2/B3/P1-P5/S1 verification scope", async () => {
  const script = await readFile("scripts/verify.mjs", "utf8");

  assert.match(script, /V0-F0\/F1\/F2\/F3\/F4\/F5\/B1\/B2\/B3\/P1\/P2\/P3\/P4\/P5\/S1 local verification passed/);
