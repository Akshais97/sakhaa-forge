...
export const BRANDS: BrandData[] = [
  {
    ...
    scripts: [
      ...
      },
      {
        ...
        setupText: 'Buy this property and expect unsupported rental ROAS claims right away.',
...
export const PRODUCTION_STAGES: ProductionStage[] = [
  ...
  },
  {
    ...
    nextSafeAction: 'Verify the live post'
  },
  {
    id: 5,
    key: 'verification',
    label: 'Verification',
    tagline: 'Evidence and recovery',
    title: 'Verify publication before calling it successful.',
    description: 'Sakhaa Forge checks the audience-facing post after provider acknowledgement and retains the publication evidence, lineage, cost state, and recovery path.',
    body: 'Provider acknowledgement is not final success. Sakhaa verifies the live URL, account, media identity, caption and visibility before marking the post as published and verified.',
    examplePrompts: [
      'Check the live public URL.',
      'Compare the media fingerprint.',
      'Confirm the caption matches the approved version.',
      'Verify the posting account.',
      'Prepare recovery if the provider state is unknown.'
    ],
    uiLabels: [
      'Provider acknowledgement stored',
      'Live URL checked',
      'Media fingerprint compared',
      'Caption verified',
      'Account ownership verified',
      'Cost state reconciled',
      'Evidence retained'
    ],
