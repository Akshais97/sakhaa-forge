  ...
  return (
    <header className="shrink-0 z-40 w-full border-b border-white/5 bg-zinc-950/80 backdrop-blur-xl px-5 py-3 flex items-center justify-between" id="app-header">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
              <span className="font-display font-bold text-sm tracking-wider text-white uppercase flex items-center gap-1.5">
              Sakhaa Forge
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-2 border border-white/5 bg-white/2 rounded-lg px-2.5 py-1 font-mono text-xs">
