export default function AppProfilePage() {
  const fields = ["Name", "Contact email", "Website URL", "Industry", "Primary market", "Language"];
    ...
    <main className="min-h-dvh bg-[#121110] px-5 py-6 text-[#F3F2EF]">
      <section className="mx-auto max-w-2xl">
        ...
        <form className="mt-6 space-y-4 rounded-md border border-white/10 bg-white/[0.04] p-4">
          ...
          <button className="rounded-md bg-[#6557F5] px-4 py-2 text-sm font-semibold text-white">Save profile</button>
        </form>
      </section>
    </main>
  );
